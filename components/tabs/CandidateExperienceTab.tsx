        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                    ...
                    <Card>
                        <CardHeader title="Find Common Availability" description="Select a candidate and interviewers to find the best time to meet." />
                        <div className="mt-4 space-y-3">
                            <div><label className="label">Candidate</label><select className="input-field"><option>{candidates[0]?.name}</option></select></div>
                            <div><label className="label">Job</label><select className="input-field"><option>{requisitions[0]?.title}</option></select></div>
                            <div><label className="label">Interviewers</label><select className="input-field" multiple><option>Casey Newton</option><option>Alex Rivera</option></select></div>
                            <p className="text-center text-sm text-gray-500 py-4">Availability Visualizer Coming Soon</p>
                            <Button className="w-full" disabled>Schedule Interview</Button>
                        </div>
                    </Card>
                </div>
